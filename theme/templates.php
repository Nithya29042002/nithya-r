...
<head>
<meta charset="utf-8">
<title>ERAGON/ <?php echo $title;?></title>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">ERAGON<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Weaver's Colony, Gottigere Post, Bannerghatta Road,<br>
          Bangalore, Karnataka. 
          Pin-code - 560083 Bangalore Karnataka.</address>
          <p>
            <i class="icon-phone"></i> (+91)7865438912  <br>
            <i class="icon-envelope-alt"></i> ammu@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Eragon 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="social-network">
            <li><a href="https://m.facebook.com" title="Facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="https://twitter.com" title="Twitter"><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://in.linkedin.com" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
            <li><a href="https://in.pinterest.com" title="Pinterest"><i class="fa fa-pinterest"></i></a></li>
            <li><a href="https://www.google.com" title="Google plus"><i class="fa fa-google-plus"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
